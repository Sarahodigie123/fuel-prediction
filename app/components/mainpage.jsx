...
export default function mainpage() {
  return (
    <div className="grid place-items-center h-screen">
      <header className="text-4xl font-bold mb-0 mt-6 ">Lets predict the rate of fuel ⬇️ </header>
      <div className="shadow-lg p-11 rounded-lg border-t-4 border-purple-400">
        <form
          onSubmit={(e) => {
            e.preventDefault();
            loginAPI();
